...
class CheckoutService(
    ...
    override fun checkout(command: CheckoutCommend): Mono<CheckoutResult> {
    ...
    private fun createPaymentEvent(command: CheckoutCommend, products: List<Product>): PaymentEvent {
        return PaymentEvent(
